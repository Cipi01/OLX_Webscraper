...
for values in region_id.values():
    for page in range(1, 25):
        offset = 40 * page

        querystring = {"offset": f"{offset}", "limit": "40", "category_id": "84", "region_id": f"{values}",
                       "filter_refiners": "spell_checker",
                       "sl": "1880c28a32ex6c06d152"}
...
for val_region in region_id.values():
    for values in brand_id.values():
        for page in range(1, 25):
            offset = 40 * page

            querystring = {"offset": f"0", "limit": "40", "category_id": f"{values}", "region_id": f"{val_region}",
                           "filter_refiners": "spell_checker",
                           "sl": "1880c28a32ex6c06d152"}
